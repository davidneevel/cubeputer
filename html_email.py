...
def generate_email(gmail_user, to_list, data_path_1, data_path_2):
...
img1 = dict(title = 'Testing the circuit', path = 'images/cubeputer01.jpg', cid = str(uuid.uuid4()))

img2 = dict(title = 'Designing concrete forms', path = 'images/cubeputer02.jpg', cid = str(uuid.uuid4()))

img3 = dict(title = 'Assembled, laser cut concrete form', path = 'images/cubeputer03.jpg', cid = str(uuid.uuid4()))
# image 4 not used! it's ugly!
img5 = dict(title = 'Wireless charging test', path = 'images/cubeputer05.jpg', cid = str(uuid.uuid4()))
img8 = dict(title = 'Wireless charging test', path = 'images/cubeputer08.jpg', cid = str(uuid.uuid4()))
img10 = dict(title = 'Wireless charging test', path = 'images/cubeputer10.jpg', cid = str(uuid.uuid4()))
img11 = dict(title = 'Wireless charging test', path = 'images/cubeputer11.jpg', cid = str(uuid.uuid4()))
img12 = dict(title = 'Wireless charging test', path = 'images/cubeputer12.jpg', cid = str(uuid.uuid4()))
img13 = dict(title = 'Wireless charging test', path = 'images/cubeputer13.jpg', cid = str(uuid.uuid4()))
img15 = dict(title = 'Wireless charging test', path = 'images/cubeputer15.jpg', cid = str(uuid.uuid4()))

email_msg = generate_email(gmail_user, [email_to], 'test_data.txt', 'test_data_2.txt')
